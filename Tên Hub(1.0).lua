...
local ToggleAutoTurnOnRacev3 = Tabs.Setting:AddToggle("ToggleAuto Turn On v3", {Title = "Auto Turn On v3", Default = true })
...
local ToggleAutoTurnOnRacev4 = Tabs.Setting:AddToggle("ToggleAuto Turn On v4", {Title = "Auto Turn On v4", Default = true })
